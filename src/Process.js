        ...
        <div id="process">
            ...
            <div className="carousel">
                ...
                <div className="slides">
                    <div className="slide" style={{ transform: `translateX(-${slide * 100}%)` }}>Step 1</div>
                    <div className="slide" style={{ transform: `translateX(-${slide * 100}%)` }}>Step 2</div>
                    <div className="slide" style={{ transform: `translateX(-${slide * 100}%)` }}>Step 3</div>
                    <div className="slide" style={{ transform: `translateX(-${slide * 100}%)` }}>Step 4</div>
                </div>
                <div className="dots">
